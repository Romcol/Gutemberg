...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link rel="stylesheet" href="<?php echo asset('css/bootstrap.min.css')?>" integrity="sha384-1q8mTJOASx8j1Au+a5WDVnPi2lkFfwwEAa8hDDdjZlpLegxhjVME1fgjWPGmkzs7" crossorigin="anonymous">
